package com.dangdangnet.common.dto.util;
...
public class FileUtils {
	...
	private static byte[] getImageFromNetByUrl(String strUrl) {
		try {
			...
			log.info("error in FileUtils-getImageFromNetByUrl:{}",e);
		}
		return null;
	}
	...
	private static File getFileFromBytes(byte[] b, String suffix) {
		...
		try {
			...
			log.info("error in FileUtils-getFileFromBytes :{}",e);
		} finally {
			if (stream != null) {
				try {
					stream.close();
	...
	public static MultipartFile createImg(String url) {
		try {
			...
			log.info("error in FileUtils-createImg :{}",e);
			return null;
		}
	}
	...
	public static MultipartFile fileToMultipart(String filePath) {
		try {
			...
			log.info("error in FileUtils-fileToMultipart:{}",e);
			return null;
		}
	}
