		...
		<div class="middle">
			<div class="login">
				<div class="l1 ">
					...
					<font color="red">><c:if test="${error!=null}">${error}</c:if></font>
				</div>
				...
				用户名:
					...
					地址:
					<div class="input2">
						<input type="text" class="input1_01" name="addr"/>
					</div>
					<div class="blank_01"></div>
					手机号:
					<div class="input2">
						<input type="text" class="input1_01" name="phone"/>
					</div>
				<div class="blank_01"></div>
				</form>
				<div class="blank_01"></div>
